/************************************************************************
 ...
 Target:
 1. if timeout for server waiting, it will exit from the forever-loop handle_events 
    and server will end
************************************************************************/
...
int MyTask::svc()
{
    ...
    if (ACE_Reactor::instance()->remove_handler(&handler, ACE_Event_Handler::READ_MASK | ACE_Event_Handler::DONT_CALL) == -1)
    {
